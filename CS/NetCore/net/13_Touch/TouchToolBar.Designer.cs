namespace InputManWin13_Demo._13_Touch
{
    partial class TouchToolBar
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TouchToolBar));
            ...
            this.label11.Text = "※この機能はWindows 8以降のタッチデバイス使用時に動作します。";
            // 
            // checkBox1
            // 
            ...
            this.checkBox2.Text = "選択テキストのタップで表示";
            ...
            this.checkBox3.Text = "グリッパーのタップで表示";
            ...
            this.groupBox1.Text = "タッチツールバーの表示方法";
            // 
            // gcMaskedComboBox1
            // 
            ...
            this.Description = "タッチ操作により表示されるタッチツールバーを提供します。カスタマイズして独自のメニューを追加することも可能です。";
            this.Name = "TouchToolBar";
            this.Title = "タッチツールバー";
