...
public partial class DropDownButton : InputManWin13_Demo.DemoBase_settings
{
    ...
    private void InitializeForm()
    {
        ...
        // FlatStyleプロパティ
        gcComboBox2.SelectedIndexChanged += (s, e) => SetFlatStyle();

        // サイドボタンの位置
        gcComboBox3.SelectedIndexChanged += (s, e) => SetSideButtonPosition();

        // サイドボタンの前景色
        gcColorPicker1.SelectedIndexChanged += (s, e) => SetSideButtonForeColor();

        // サイドボタンの背景色
        gcColorPicker2.SelectedIndexChanged += (s, e) => SetSideButtonBackColor();

        // ドロップダウンの既定機能
        checkBox1.CheckedChanged += (s, e) => SetDropDownDefaultBehavior();

        // NavigateOnWheelプロパティ
        checkBox2.CheckedChanged += (s, e) => SetNaavigateOnWheel();
    ...
    private void SetSideButtonPosition()
    {
    ...
    private void SetSideButtonForeColor()
    {
    ...
    private void SetSideButtonBackColor()
    {
    ...
    private void SetDropDownDefaultBehavior()
    {
    ...
    private void SetNaavigateOnWheel()
    {
